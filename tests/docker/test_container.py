...
class TestContainer(TestCase):
    ...
    def test_determine_volumes(self, mock_check_output):
        ...
        self.assertFalse(container.has_docker_bindings, "Unexpected docker bindings found!")
        self.assertEqual(container.docker_bindings, [], "Unexpected docker bindings found!")
