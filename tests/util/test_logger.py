...
class TestLogger(unittest.TestCase):
    ...
    @patch("docker_volume_backup.util.logger.os.getenv", return_value="../bar")
    def test_init_logger(self, logdir):
        self.assertEqual(None, Logger.init_logger(loglevel=logging.DEBUG, identifier="Foo"))

    @patch("docker_volume_backup.util.logger.os.getenv", return_value=None)
    def test_logdir_undefined(self, logdir):
        self.assertEqual(None, Logger.init_logger(loglevel=logging.DEBUG, identifier="Foo"))

    @patch("docker_volume_backup.util.logger.os.getenv", return_value="")
