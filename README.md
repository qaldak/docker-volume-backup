...
| IMAGE_REFRESH_DAY  | (optional) Day of month on which the `busybox` base image is pulled from the registry, e.g. `1`. <br> Default (if undefined or invalid): `1`. On all other days the locally cached image is reused. |
